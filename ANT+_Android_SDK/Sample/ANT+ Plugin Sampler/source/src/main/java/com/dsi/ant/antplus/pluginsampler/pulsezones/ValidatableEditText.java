...
public class ValidatableEditText extends EditText {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ValidatableEditText);
        minValueAttr = a.getInt(R.styleable.ValidatableEditText_min_value, 1);
        maxValueAttr = a.getInt(R.styleable.ValidatableEditText_max_value, 130);
